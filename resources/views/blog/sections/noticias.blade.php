...
@section('content')
    <div id="main_" class="row w-100 d-flex justify-content-center align-items-center m-0 h-100" style="padding: 0 10%;">
        ...
        @else
            ...
            <div class="col-12 cont-not p-0" style="    height: 300px; background-image: url(../multimedia/{{$big->file_path}}/{{$big->slug}}/{{$big->file}});">
                {{-- <div class="row w-100 justify-content-center align-items-center h-100" style=" z-index: 90; background: white; text-align: justify; padding: 0% 0 2% 3%; height: 70vh;" > --}}
